...
export async function PUT(request: Request) {
    try {
        ...
        const data = {
            ...
            swedbankPayTitle: body.swedbankPayTitle,
            swedbankPayDescription: body.swedbankPayDescription,
            swedbankPayLanguage: body.swedbankPayLanguage,
            swedbankPayTermsUrl: body.swedbankPayTermsUrl,
            swedbankPayLogoUrl: body.swedbankPayLogoUrl,
            swedbankPayInstantCapture: body.swedbankPayInstantCapture,
            swedbankPayAutoOrderStatus: body.swedbankPayAutoOrderStatus,

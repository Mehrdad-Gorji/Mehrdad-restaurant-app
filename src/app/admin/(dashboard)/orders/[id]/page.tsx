...
export default async function OrderPage({ params }: Props) {
    ...
    try {
        ...
        const vatSettings = {
            vatEnabled: settingsRaw?.vatEnabled ?? true,
            vatNumber: settingsRaw?.vatNumber ?? '',
            vatRateStandard: settingsRaw?.vatRateStandard ?? 0.19,
            vatRateReduced: settingsRaw?.vatRateReduced ?? 0.07,
            vatPriceInclusive: settingsRaw?.vatPriceInclusive ?? true
        };
